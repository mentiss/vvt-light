// src/server/systems/achtung/socket/session-resources.js
// Handler Socket.io pour les ressources de session Achtung! Cthulhu.
...
//   session-resources-update      → tous (momentum + threat, sans complications)
...
const ALLOWED = ['momentum', 'threat', 'complications'];
const CLAMP   = {
